...
function(stm43g4_add_stlink_targets target)
    if(TARGET st-flash-write)
        message(WARNING "stm43g4_add_stlink_targets(${target}) already called, ignoring.")
        return()
    endif()
    ...
    if(NOT TARGET ${target}-ihex)
        message(FATAL_ERROR "stm43g4_add_stlink_targets() depends on IHEX file generated by stm32g4_target_generate_ihex()")
    endif()
    ...
    add_custom_target(st-flash-write
        "${ST_FLASH}" --reset --format ihex ${STLINK_FREQ_ARG} write "${target}.hex"
        DEPENDS ${target}.hex
    )
    add_custom_target(st-flash-reset
        "${ST_FLASH}" ${STLINK_FREQ_ARG} reset
    )
endfunction()
